package cn.tsjcate.groupon.order.dao;
...
public class OrderDAO extends BaseMybatisDAO {
    ...
    private static final String ORDER_MAPPER_NAMESPACE = "com.tortuousroad.groupon.order.entity.OrderMapper";

    private static final String ORDERDETAIL_MAPPER_NAMESPACE = "com.tortuousroad.groupon.order.entity.OrderDetailMapper";
