...
//加载ckeditor
    function initDealDetailCKEditor() {
        ...
        /*{filebrowserUploadUrl:'<#--${ctx}-->/image/ckeuploadfile?module=dealDetail'}*/
...
<div style="margin-bottom:5px; display:inline;">
    ...
    <label>商品类别:</label>
    <input name="search_categoryId" class="easyui-combotree" data-options="url:'${ctx}/product/category/buildProductCategoryTree',method:'get',lines:true" value="${search_categoryId}">
</div>
</@search_macro.search2>
<div id="tb" style="padding:1px;height:auto">
    <div style="margin-bottom:1px">
        <a href="javascript:;" class="easyui-linkbutton" iconCls="icon-add" onclick="addProduct();" plain="true" title="添加商品">添加商品</a>
        <a href="javascript:;" class="easyui-linkbutton" iconCls="icon-edit" onclick="updateProduct();" plain="true" title="修改商品">修改商品</a>
    </div>
</div>
...
<div id="product_edit_dialog" class="easyui-dialog"
     style="width:1024px;height:668px;" data-options="closed:true,maximizable:true">
</div>
</body>